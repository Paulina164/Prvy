...
Zaulímalo by nás či náhodou účinnosť lieku nezávisí od počtu epileptických záchvatov pacienta pred liečbou (Case_Base). Vizuálne z grafu závislosti sa to posúdiť nedá:
```{r}
ggplot(data = Data1) +
